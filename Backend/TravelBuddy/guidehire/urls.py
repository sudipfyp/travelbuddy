...
from .views import GuideHireView, GuideHireProposal, GuideHireProposalAccept, GuideHireProposalReject, GuideHireCancel, CurrentGuideHire
...
urlpatterns = [
    ...
    path('hire/reject/<int:id>/',GuideHireProposalReject.as_view()), #accept the hire req.. id means the proposal id
    path('hire/cancel/<int:id>/',GuideHireCancel.as_view()), #accept the hire req.. id means the proposal id
]
